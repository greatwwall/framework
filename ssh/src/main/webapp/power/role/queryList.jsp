          ...
          <c:forEach  items="${roles}"  var="role">
	          	<tr>
		            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
		              <input name="userCb" type="checkbox" class="STYLE2" value="${role.roleId}" />
		            </div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${role.roleId }</div></td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${role.roleName }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center">
            			<span class="STYLE1">[</span>
	            			<img src="assets/images/037.gif" width="9" height="9" />
            				<a  href="power/menuAction!findAllOfDistribute?roleId=${role.roleId}" >分配菜单</a>
            			<span class="STYLE1">]</span>
            			<span class="STYLE1">[</span>
	            			<img src="assets/images/037.gif" width="9" height="9" />
            				<a  href="power/moduleAction!findAllOfDistribute?roleId=${role.roleId}" >分配模块</a>
            			<span class="STYLE1">]</span>
	            		<span class="STYLE1">[</span>
